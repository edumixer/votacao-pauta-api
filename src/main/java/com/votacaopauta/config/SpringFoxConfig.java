...
public class SpringFoxConfig implements WebMvcConfigurer {
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder()
				...
				.description("API para gerenciar as sessões de votação de pautes com a UrnaAPI.")
				.version("1.0")				
				.build();
	}	
	...
	private Tag[] tags() {
		return new Tag[] {
				new Tag("Pautas", "Gerenciar as pautas"),
				new Tag("Sessões de votação", "Gerencia as sessões de votação"),
				new Tag("Votos", "Gerenciar os votos"),
				new Tag("Users", "Validar os CPF dos eleitores")
		};
	}
